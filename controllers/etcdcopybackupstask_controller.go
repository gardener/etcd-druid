...
func getConditions(jobConditions []batchv1.JobCondition) []gardencorev1beta1.Condition {
	...
	for _, jobCondition := range jobConditions {
		if conditionType := getConditionType(jobCondition.Type); conditionType != "" {
			conditions = append(conditions, gardencorev1beta1.Condition{
				Type:               conditionType,
				Status:             gardencorev1beta1.ConditionStatus(jobCondition.Status),
...
func getConditionType(jobConditionType batchv1.JobConditionType) gardencorev1beta1.ConditionType {
