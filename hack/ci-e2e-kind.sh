...
# if RETAIN_TEST_ARTIFACTS is set to true, the test artifacts will be retained and the kind cluster will not be deleted
if [[ "${RETAIN_TEST_ARTIFACTS:-false}" != "true" ]]; then
  trap '{
