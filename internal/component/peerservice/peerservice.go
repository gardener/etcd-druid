...
func buildResource(etcd *druidv1alpha1.Etcd, svc *corev1.Service) {
	...
	// Peer service should only target StatefulSet pods. enabledByDefault labels are going to be present on anything that is managed by etcd-druid and started for an etcd cluster.
