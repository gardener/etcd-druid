...
//		var (
//			etcdList v1alpha1.EtcdList
//		)
//
//		BeforeEach(func() {
//			etcdList = v1alpha1.EtcdList{}
//			for i := 0; i < 3; i++ {
//				etcdList.Items = append(etcdList.Items, v1alpha1.Etcd{
...
//			etcdList.Items[0].Spec.Etcd.ClientUrlTLS = &v1alpha1.TLSConfig{
...
//			etcdList.Items[1].Spec.Etcd.PeerUrlTLS = &v1alpha1.TLSConfig{
//				ServerTLSSecretRef: corev1.SecretReference{
//					Name:      testSecretName,
//					Namespace: testNamespace,
//				},
...
//			etcdList.Items[2].Spec.Backup.Store = &v1alpha1.StoreSpec{
