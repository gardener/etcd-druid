...
func (env *ReconcilerTestEnv) InjectHTTPClient(httpClient *http.Client) {
	...
	registry.Register("OnDemandSnapshot", func(k8sclient client.Client, logger logr.Logger, task *druidv1alpha1.EtcdOpsTask, _ *http.Client) (task.Handler, error) {
