...
func (f *FakeEtcdOpsTaskHandler) WithExecute(r handler.Result) *FakeEtcdOpsTaskHandler {
	f.RunResult = r
	return f
}
...
func (f *FakeEtcdOpsTaskHandler) Execute(ctx context.Context) handler.Result { return f.RunResult }
