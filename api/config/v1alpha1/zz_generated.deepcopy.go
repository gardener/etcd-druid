...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSServerConfiguration) DeepCopyInto(out *TLSServerConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSServerConfiguration.
func (in *TLSServerConfiguration) DeepCopy() *TLSServerConfiguration {
	if in == nil {
		return nil
	}
	out := new(TLSServerConfiguration)
	in.DeepCopyInto(out)
	return out
}
