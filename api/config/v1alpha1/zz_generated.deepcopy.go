...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnDeleteControllerConfiguration) DeepCopyInto(out *OnDeleteControllerConfiguration) {
	*out = *in
	if in.ConcurrentSyncs != nil {
		in, out := &in.ConcurrentSyncs, &out.ConcurrentSyncs
		*out = new(int)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnDeleteControllerConfiguration.
func (in *OnDeleteControllerConfiguration) DeepCopy() *OnDeleteControllerConfiguration {
	if in == nil {
		return nil
	}
	out := new(OnDeleteControllerConfiguration)
	in.DeepCopyInto(out)
	return out
}
