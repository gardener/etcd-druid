...
func (in *AdditionalPeerURL) DeepCopyInto(out *AdditionalPeerURL) {
	*out = *in
	if in.URLs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdditionalPeerURL.
func (in *AdditionalPeerURL) DeepCopy() *AdditionalPeerURL {
	if in == nil {
		return nil
	}
	out := new(AdditionalPeerURL)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EtcdConfig) DeepCopyInto(out *EtcdConfig) {
	*out = *in
	...
	if in.AdditionalAdvertisePeerURLs != nil {
		...
		*out = make([]AdditionalPeerURL, len(*in))
		for i := range *in {
