...
func (in *AdditionalClientURLsSpec) DeepCopyInto(out *AdditionalClientURLsSpec) {
	*out = *in
	...
	if in.Members != nil {
		...
		*out = make([]MemberClientURLs, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemberClientURLs) DeepCopyInto(out *MemberClientURLs) {
	*out = *in
	if in.URLs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemberClientURLs.
func (in *MemberClientURLs) DeepCopy() *MemberClientURLs {
	if in == nil {
		return nil
	}
	out := new(MemberClientURLs)
	in.DeepCopyInto(out)
	return out
}
