...
func (in *EtcdOpsTaskConfig) DeepCopyInto(out *EtcdOpsTaskConfig) {
	*out = *in
	...
	if in.RecoverFromQuorumLoss != nil {
		...
		*out = new(RecoverFromQuorumLossConfig)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RecoverFromQuorumLossConfig) DeepCopyInto(out *RecoverFromQuorumLossConfig) {
	*out = *in
	if in.ScaleDownTimeout != nil {
		in, out := &in.ScaleDownTimeout, &out.ScaleDownTimeout
		*out = new(metav1.Duration)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecoverFromQuorumLossConfig.
func (in *RecoverFromQuorumLossConfig) DeepCopy() *RecoverFromQuorumLossConfig {
	if in == nil {
		return nil
	}
	out := new(RecoverFromQuorumLossConfig)
